...
public class Loader {
    ...
    public RawModel loadToVAO(float[] positions,float[] textureCoordinates,float[] normals , int[] indices){
        ...
        storeDaraInAttributeList(0,3,positions);
        storeDaraInAttributeList(1,2,textureCoordinates);
        storeDaraInAttributeList(2,3,normals);
        unbindVAO();
    ...
    public RawModel loadToVAO(float[] positions){
        int vaoID = createVAO();
        this.storeDaraInAttributeList(0,2,positions);
        unbindVAO();
    ...
    private void storeDaraInAttributeList (int attributeNumber,int coordinatesSize, float[] data){
